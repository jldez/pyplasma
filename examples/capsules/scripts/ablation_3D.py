...
def single_pulse(output,
    ...
    results = domain.run(4*laser.pulse_duration, stability_factor=0.9, verbose=last_results is None)

    # print(results['rho'].max()/rho_star)
    ...
    # print(np.mean(nb_ablated_cells)*domain.dx/nm)
