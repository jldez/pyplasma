...
mat = pp.Material(index=1.0, bandgap=5e-19, density=2e28, cross_section=1e-19, damping=1e15, resonance=120e-9, rate_equation='sre')
...
print(results['electric_field'].max())
